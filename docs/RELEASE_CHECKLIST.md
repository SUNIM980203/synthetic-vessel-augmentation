# Author-authorized archive checks

- [x] Record user-supplied author order and final paper title (see AUTHOR_METADATA.md).
- [x] Record user confirmation of coauthor/professor consent to material publication.
- [x] Record public research contact and no-separate-provision policy for excluded materials.
- [x] Sunjin Yu affiliation number 3 confirmed by user; ORCIDs optional and not supplied.
- [x] User approved SUNIM980203/synthetic-vessel-augmentation with public visibility, after release checks.
- [x] Run text/source inventory checks for prohibited binaries, local user paths and secret-like tokens; no matching findings. This is not a legal rights certification.
- [x] Add upstream distributor entry points and author policy refusing separate supply of withheld materials; download availability and exact replay are not guaranteed.
