#!/usr/bin/env python3
"""Frozen factorial contrasts, Student-t intervals, and exact sign tests."""
...
OUTPUT_JSON = common.STATISTICS_DIR / "scope_lr_factorial_statistics.json"
PER_SEED_CSV = common.STATISTICS_DIR / "scope_lr_factorial_per_seed_contrasts.csv"
RAW_CSV = common.METRICS_DIR / "scope_lr_factorial_metrics_long.csv"
ABSOLUTE_CSV = common.TABLES_DIR / "scope_lr_factorial_absolute_AP.csv"
...
def main() -> int:
    ...
    payload = {
        "study": "fresh condition x scope x learning-rate factorial",
