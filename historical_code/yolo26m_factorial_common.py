#!/usr/bin/env python3
"""Result-independent definitions for the frozen YOLO26m scope x LR factorial."""
...
STUDY = ROOT / "yolo26m_scope_lr_factorial_followup_v1"
SOURCE_DIR = STUDY / "00_sources"
ARCHITECTURE_DIR = STUDY / "01_architecture"
INITIAL_DIR = STUDY / "02_checkpoint"
PROTOCOL_DIR = STUDY / "03_protocol"
ENVIRONMENT_DIR = STUDY / "04_environment"
CONFIG_DIR = STUDY / "05_configs"
ORDER_DIR = STUDY / "06_schedule"
RUNS_DIR = STUDY / "07_runs"
FAILED_DIR = STUDY / "08_failed_runs"
CHECKPOINTS_DIR = STUDY / "02_checkpoint"
PREDICTIONS_DIR = STUDY / "09_predictions"
METRICS_DIR = STUDY / "10_metrics"
STATISTICS_DIR = STUDY / "11_statistics"
SCENE_DIR = STUDY / "12_scene"
MODEL_COMPARISON_DIR = STUDY / "13_three_model_comparison"
TABLES_DIR = STUDY / "14_tables"
FIGURES_DIR = STUDY / "15_figures"
AUDITS_DIR = STUDY / "16_audits"
REPORT_DIR = STUDY / "17_final_report"
...
INITIAL_CHECKPOINT = CHECKPOINTS_DIR / "yolo26m_xview_initial_locked.pt"
INITIAL_CONFIG = INITIAL_DIR / "yolo26m_xview_initial_checkpoint_config.json"
INITIAL_LOCK_JSON = INITIAL_DIR / "yolo26m_xview_initial_checkpoint_lock.json"
INITIAL_LOCK_MD = INITIAL_DIR / "yolo26m_xview_initial_checkpoint_lock.md"
FROZEN_CONFIG = CONFIG_DIR / "yolo26m_factorial_frozen_training_config.json"
EXECUTION_ORDER = ORDER_DIR / "yolo26m_factorial_execution_order.csv"
PROTOCOL_JSON = PROTOCOL_DIR / "yolo26m_factorial_protocol_v1.json"
PROTOCOL_MD = PROTOCOL_DIR / "yolo26m_factorial_protocol_v1.md"
PROTOCOL_LOCK = PROTOCOL_DIR / "yolo26m_factorial_PROTOCOL_LOCK.txt"
ANALYSIS_MANIFEST = PROTOCOL_DIR / "yolo26m_factorial_analysis_manifest.json"
TRAINING_LEDGER = AUDITS_DIR / "yolo26m_factorial_training_ledger.json"
EVALUATION_LEDGER = AUDITS_DIR / "yolo26m_factorial_evaluation_ledger.json"
...
def assert_protocol_locked() -> None:
    ...
    if sha256_file(INITIAL_CHECKPOINT) != expected_initial_sha256():
        raise RuntimeError("fixed YOLO26m initial checkpoint hash mismatch")
